...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int allPaymentsForTheMonth = 0;
        int[] arr = generateRandomArray();
        for (int value : arr) {
            allPaymentsForTheMonth += value;
        }
        System.out.println("Сумма трат за месяц составила " + allPaymentsForTheMonth + "рублей");
        System.out.println();
        ...
        int minPaymentsForTheMonth = arr2[0];
        int maxPaymentsForTheMonth = arr2[0];
        for (int element : arr2) {
            if (element < minPaymentsForTheMonth) {
                element = minPaymentsForTheMonth;
            } else if (element > maxPaymentsForTheMonth) {
                element = maxPaymentsForTheMonth;
            }
        }
        System.out.println("Минимальная сумма трат за день составила " + minPaymentsForTheMonth + " рублей.");
        System.out.println("Максимальная сумма трат за день составила " + maxPaymentsForTheMonth + " рублей.");
        System.out.println();
        ...
        int sumPaymentsForTheMonth = 0;
        int[] arr3 = generateRandomArray();
        for (int value : arr3) {
            sumPaymentsForTheMonth += value;
